...
import (
	...
	v1beta1labels "github.com/kanopy-platform/gateway-certificate-controller/pkg/v1/labels"
...
const (
	TestNamespace       = "test"
	TestGatewayName     = "mygateway"
	TestCertificateName = "mygateway-cert"
	TestCertNamespace   = "certnamespace"
)
...
func (r *controllerSpy) CreateCertificate(ctx context.Context, gateway *v1.Gateway, server *networkingv1.Server) error {
	r.CreateCalled++
	if r.Error {
...
func (r *controllerSpy) UpdateCertificate(ctx context.Context, cert *v1certmanager.Certificate, gateway *v1.Gateway, server *networkingv1.Server) error {
	r.UpdateCalled++
	if r.Error {
